//
//  UI_PopupWindowBase.h

//  Created by Lee Haengkeun on 2014. 3. 21..
//

//  팝업 윈도우에 대한 Base Class
//


#ifndef r_one_UI_PopupWindowBase_h
#define r_one_UI_PopupWindowBase_h
...
public:
	...
	virtual bool init()final;   //초기화 함수는 다시 오버라이드 되지않고  초기화자를 실행하고자한다만onInit() 함수를 오버라이드하자
	virtual bool onInit();
...
protected:
	...
	cocos2d::Layer  *m_ParrentLayer;    //부모 Layer => 팝업은 항상 Layer를 부모를 가져야한다. 만약부모가 Layer가 아닌경우 그냥 Null을 설정할것
