//
//  UI_GameResultWindow.cpp
//
//  Created by Mr.Ru on 2015. 11. 3..
//
//
#include "stdafx.h"
...
void UIPopupWindow::setBackgroundBorard(Sprite  *sprBg)//팝업 아래에 투명이나 머 이런거? 하여간맨 밑바닥
{
	if (!sprBg)return;
...
void UIPopupWindow::addButton(const char* normalTexture, const char* selectedTexture, const char* disabledTexture
	, Widget::TextureResType texType, const Point &pos, const std::string& text, const int nTag)
{
